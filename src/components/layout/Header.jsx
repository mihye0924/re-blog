            ...
            <div className={header.header}>
                ...
                <div className={header.header_button}>
                    <button className={header.header_alarm}>
                        <img src={`${import.meta.env.BASE_URL}/images/layout/alarm.png`} alt="알림"/>
                    </button>
            ...
            <div className={header.header}>
                ...
                <div className={header.header_button}>
                    <button className={header.header_alarm_black}>
                        <img src={`${import.meta.env.BASE_URL}/images/layout/alarm_black.png`} alt="알림"/>
                    </button>
                    <Link className={header.header_profile} to="Profile" >
                    <img src={
                        profile.img !== '' ? 
                        profile.img : 
                        `${import.meta.env.BASE_URL}/images/common/thumbnail.svg`
                        } alt="프로필"
                    />        
                    </Link> 
